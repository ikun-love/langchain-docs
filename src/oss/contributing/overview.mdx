...
<AccordionGroup>
    ...
    <Accordion title="改进文档" icon="book">
        ...
        <Card title="如何建议修改文档" href="/oss/contributing/documentation" arrow>指南</Card>
    </Accordion>

    <Accordion title="贡献代码" icon="code">
        由于用户量很大，我们的小团队很难跟进所有的特性请求和 Bug 修复。如果您有技能和时间，我们非常希望得到您的帮助！

        <Card title="如何提交您的第一个 Pull Request" href="/oss/contributing/code" arrow>指南</Card>
    ...
    <Accordion title="添加新集成" icon="plug-circle-plus">
        ...
        <Card title="LangChain" icon="link" href="/oss/contributing/integrations-langchain" arrow>添加新的 LangChain 集成指南</Card>
    </Accordion>
</AccordionGroup>
