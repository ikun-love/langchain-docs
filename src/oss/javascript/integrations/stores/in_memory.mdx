...
这将帮助您开始使用 [InMemoryStore](/oss/integrations/stores)。有关 `InMemoryStore` 所有功能和配置的详细文档，请访问 [API 参考](https://api.js.langchain.com/classes/langchain_core.stores.InMemoryStore.html)。
