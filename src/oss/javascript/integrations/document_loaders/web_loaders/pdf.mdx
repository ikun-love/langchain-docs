...
本 Notebook 提供了关于如何开始使用 [WebPDFLoader](/oss/integrations/document_loaders/) 的快速概述。如需了解 WebPDFLoader 所有功能和配置的详细文档，请查阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_document_loaders_web_pdf.WebPDFLoader.html)。
