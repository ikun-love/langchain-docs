...
本笔记快速概述如何开始使用 `RecursiveUrlLoader`（[递归URL加载器](/oss/integrations/document_loaders/)）。有关 `RecursiveUrlLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_document_loaders_web_recursive_url.RecursiveUrlLoader.html)。
