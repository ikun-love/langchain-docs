...
本指南快速概述了如何开始使用 `DirectoryLoader` [文档加载器](/oss/integrations/document_loaders)。有关 `DirectoryLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain.document_loaders_fs_directory.DirectoryLoader.html)。
