...
本 Notebook 提供了关于如何开始使用 `PDFLoader` 文档加载器的快速指南，该加载器属于 [文档加载器](/oss/integrations/document_loaders) 系列。如需了解 `PDFLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_document_loaders_fs_pdf.PDFLoader.html)。
