...
本指南快速概述了如何开始使用 `CSVLoader` [文档加载器](/oss/integrations/document_loaders)。要获取 `CSVLoader` 所有特性和配置的详细文档，请查阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_document_loaders_fs_csv.CSVLoader.html)。
