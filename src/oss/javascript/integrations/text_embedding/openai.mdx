...
这将帮助您开始使用 LangChain 中的 OpenAIEmbeddings [嵌入模型](/oss/integrations/text_embedding)。有关 `OpenAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_openai.OpenAIEmbeddings.html)。
...
嵌入模型通常用于检索增强生成（RAG）流程中，无论是在索引数据阶段还是在后续的检索阶段。有关更详细的说明，请参阅 [**学习 (Learn)** 选项卡下的 RAG 教程](/oss/learn/)。
...
如果您正在 Azure OpenAI 上托管服务，请参阅[专用页面](/oss/integrations/text_embedding/azure_openai)。
