...
本指南提供了开始使用 SerpAPI [工具](/oss/integrations/tools/)的快速概述。有关所有 `SerpAPI` 功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/_langchain_community.tools_serpapi.SerpAPI.html)。
