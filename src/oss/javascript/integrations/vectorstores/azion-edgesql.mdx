...
本指南将快速介绍如何开始使用 Azion EdgeSQL [向量存储](/oss/integrations/vectorstores)。有关 `AzionVectorStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/_langchain_community.vectorstores_azion_edgesql.AzionVectorStore.html)。
