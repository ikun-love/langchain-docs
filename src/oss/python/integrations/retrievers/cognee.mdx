...
这将帮助您开始使用 Cognee [检索器](/oss/langchain/retrieval)。有关 CogneeRetriever 所有功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.cognee.CogneeRetriever.html)。
...
如果您想从单个查询中获得自动化的追踪（tracing），您还可以通过取消注释以下行来设置您的 [LangSmith](https://docs.langchain.com/langsmith/home) API 密钥：
