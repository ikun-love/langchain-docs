...
[工具 (Tools)](/oss/langchain/tools) 是设计用于被模型调用的实用程序：它们的输入旨在由模型生成，它们的输出旨在传回给模型。
...
| [SearchApi](/oss/integrations/tools/searchapi) | 注册时获得 100 次免费搜索 | URL, Snippet, Title, Search Rank, Site Links, Authors |
| [SearxNG Search](/oss/integrations/tools/searx_search) | 免费 | URL, Snippet, Title, Category |
| [SerpAPI](/oss/integrations/tools/serpapi) | 每月 100 次免费搜索 | Answer |
...
| [Bearly Code Interpreter](/oss/integrations/tools/bearly) | Python | 每次执行重置 | ✅ | Text | ❌ |
| [Riza Code Interpreter](/oss/integrations/tools/riza) | Python, JavaScript, PHP, Ruby | 每次执行重置 | ✅ | Text | ✅ |
...
| [Gmail Toolkit](/oss/integrations/tools/google_gmail) | 免费，限制为每用户每秒 250 个配额单位 |
| [Infobip Tool](/oss/integrations/tools/infobip) | 免费试用，之后定价可变 |
| [Jira Toolkit](/oss/integrations/tools/jira) | 免费，有[速率限制](https://developer.atlassian.com/cloud/jira/platform/rate-limiting/) |
| [Office365 Toolkit](/oss/integrations/tools/office365) | 免费使用 Office365，包含[速率限制](https://learn.microsoft.com/en-us/graph/throttling-limits) |
| [Slack Toolkit](/oss/integrations/tools/slack) | 免费 |
| [Twilio Tool](/oss/integrations/tools/twilio) | 免费试用，之后采用[按需付费定价](https://www.twilio.com/en-us/pricing) |
...
| 工具/工具包 | 定价 | 支持与浏览器交互 |
|-------------|---------|---------------------------------------|
| [AgentQL Toolkit](/oss/integrations/tools/agentql) | 免费试用，之后提供按需付费和平铺费率方案 | ✅ |
| [Hyperbrowser Browser Agent Tools](/oss/integrations/tools/hyperbrowser_browser_agent_tools) | 免费试用，之后提供平铺费率方案和预付费积分 | ✅ |
| [Hyperbrowser Web Scraping Tools](/oss/integrations/tools/hyperbrowser_web_scraping_tools) | 免费试用，之后提供平铺费率方案和预付费积分 | ❌ |
| [MultiOn Toolkit](/oss/integrations/tools/multion) | 每天 40 次免费请求 | ✅ |
| [Oxylabs Web Scraper API](/oss/integrations/tools/oxylabs) | 免费试用，之后提供平铺费率方案和预付费积分 | ❌ |
...
| 工具/工具包 | 允许的操作 |
|-------------|-------------------|
| [Cassandra Database Toolkit](/oss/integrations/tools/cassandra_database) | SELECT 和 Schema 自省 (introspection) |
...
| 工具/工具包 | 定价 | 功能 |
|-------------|---------|--------------|
| [GOAT](/oss/integrations/tools/goat) | 免费 | 创建和接收支付、购买实物商品、进行投资等。 |
...
<Card title="Azure AI Services 工具包" icon="link" href="/oss/integrations/tools/azure_ai_services" arrow="true" cta="查看指南" />
<Card title="Azure Cognitive Services 工具包" icon="link" href="/oss/integrations/tools/azure_cognitive_services" arrow="true" cta="查看指南" />
...
<Card title="Google Calendar 工具包" icon="link" href="/oss/integrations/tools/google_calendar" arrow="true" cta="查看指南" />
...
<Card title="人类即工具" icon="link" href="/oss/integrations/tools/human_tools" arrow="true" cta="查看指南" />
<Card title="Hyperbrowser Browser Agent 工具" icon="link" href="/oss/integrations/tools/hyperbrowser_browser_agent_tools" arrow="true" cta="查看指南" />
<Card title="Hyperbrowser Web Scraping 工具" icon="link" href="/oss/integrations/tools/hyperbrowser_web_scraping_tools" arrow="true" cta="查看指南" />
...
<Card title="Linkup Search 工具" icon="link" href="/oss/integrations/tools/linkup_search" arrow="true" cta="查看指南" />
...
<Card title="Oracle AI Vector Search" icon="link" href="/oss/integrations/tools/oracleai" arrow="true" cta="查看指南" />
...
<Card title="WRITER 工具" icon="link" href="/oss/integrations/tools/writer" arrow="true" cta="查看指南" />
