...
本指南快速概述了如何开始使用 `LinkupSearchTool` [工具](/oss/langchain/tools)。要获取所有 `LinkupSearchTool` 功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/linkup/tools/linkup_langchain.search_tool.LinkupSearchTool.html)。
