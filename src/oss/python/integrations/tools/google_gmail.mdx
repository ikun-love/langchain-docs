...
本指南将帮助您开始使用 Gmail [工具包](/oss/langchain/tools#toolkits)。此工具包与 Gmail API 交互，可用于读取邮件、起草和发送邮件等操作。如需了解所有 `GmailToolkit` 功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/google_community/gmail/langchain_google_community.gmail.toolkit.GmailToolkit.html)。
...
下面展示了如何将工具包集成到一个 [Agent](/oss/langchain/agents) 中。
