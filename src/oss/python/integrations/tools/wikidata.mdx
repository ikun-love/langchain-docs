...
>[Wikidata](https://wikidata.org/) 是一个免费、开放的知识库，可供人类和机器读取和编辑。Wikidata 是世界上最大的开放知识库之一。

首先，您需要安装 `wikibase-rest-api-client` 和 `mediawikiapi` 这两个 Python 包。
...
Result Q7251:
Label: Alan Turing
Description: 英国计算机科学家 (1912–1954)
...
Result Q28846012:
Label: Alan Turing
Description: 艾伦·图灵 (1912-1954) 的虚构类比人物
