...
本指南简要介绍了如何开始使用 Jina [工具](/oss/integrations/tools/)。有关 Jina 所有功能和配置的详细文档，请参阅[API 参考文档](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.jina_search.tool.JinaSearch.html)。
...
| [返回产物](/oss/langchain/tools) | 原生异步 (Native async) | 返回数据 | 定价 (Pricing) |
| :---: | :---: | :---: | :---: |
