...
请参阅 [使用示例](/oss/integrations/vectorstores/couchbase)。
...
`CouchbaseSemanticCache` 需要定义一个搜索索引 (Search Index) 才能工作。请查看 [使用示例](/oss/integrations/vectorstores/couchbase) 如何设置索引。
