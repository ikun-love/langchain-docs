...
您可以在标准的检索管道中使用 [`ExaSearchRetriever`](/oss/integrations/tools/exa_search#using-exasearchretriever)。您可以按如下方式导入它。

有关用法示例，请参见[使用示例](/oss/integrations/tools/exa_search)。
...
如[Exa 工具调用文档](/oss/integrations/tools/exa_search#use-within-an-agent)中所述，您可以将 Exa 用作智能体工具。
