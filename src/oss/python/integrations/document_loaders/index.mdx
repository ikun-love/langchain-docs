...
文档加载器（Document Loaders）提供了一个**标准接口**，用于从不同的数据源（如 Slack、Notion 或 Google Drive）中读取数据，并将其转换为 LangChain 的 @[Document] 格式。
这确保了无论数据来自哪个源头，都可以被一致地处理。

所有的文档加载器都实现了 @[`BaseLoader`] 接口。
...
| 文档加载器 | 描述 | 包/API |
|----------------|-------------|-------------|
| [Web](/oss/integrations/document_loaders/web_base) | 使用 urllib 和 BeautifulSoup 来加载和解析 HTML 网页 | Package |
| [Unstructured](/oss/integrations/document_loaders/unstructured_file) | 使用 Unstructured 库来加载和解析网页 | Package |
| [RecursiveURL](/oss/integrations/document_loaders/recursive_url) | 从根 URL 开始递归抓取所有子链接 | Package |
| [Sitemap](/oss/integrations/document_loaders/sitemap) | 抓取给定站点地图（sitemap）中的所有页面 | Package |
| [Spider](/oss/integrations/document_loaders/spider) | 一个用于爬取和抓取网页，并返回 LLM 可用数据的爬虫 | API |
| [Firecrawl](/oss/integrations/document_loaders/firecrawl) | 可以本地部署的 API 服务 | API |
| [Docling](/oss/integrations/document_loaders/docling) | 使用 Docling 库来加载和解析网页 | Package |
| [Hyperbrowser](/oss/integrations/document_loaders/hyperbrowser) | 用于运行和扩展无头浏览器的平台，可用于抓取/爬取任何站点 | API |
| [AgentQL](/oss/integrations/document_loaders/agentql) | 使用 AgentQL 查询或自然语言提示，进行网页交互和结构化数据提取 | API |
...
| 文档加载器 | 描述 | 包/API |
|----------------|-------------|-------------|
| [PyPDF](/oss/integrations/document_loaders/pypdfloader) | 使用 `pypdf` 库来加载和解析 PDF | Package |
| [Unstructured](/oss/integrations/document_loaders/unstructured_file) | 使用 Unstructured 的开源库来加载 PDF | Package |
| [Amazon Textract](/oss/integrations/document_loaders/amazon_textract) | 使用 AWS API 来加载 PDF | API |
| [MathPix](/oss/integrations/document_loaders/mathpix) | 使用 MathPix 库来加载 PDF | Package |
| [PDFPlumber](/oss/integrations/document_loaders/pdfplumber) | 使用 PDFPlumber 库加载 PDF 文件 | Package |
| [PyPDFDirectry](/oss/integrations/document_loaders/pypdfdirectory) | 加载包含 PDF 文件的目录 | Package |
| [PyPDFium2](/oss/integrations/document_loaders/pypdfium2) | 使用 PyPDFium2 库加载 PDF 文件 | Package |
| [PyMuPDF](/oss/integrations/document_loaders/pymupdf) | 使用 PyMuPDF 库加载 PDF 文件 | Package |
| [PyMuPDF4LLM](/oss/integrations/document_loaders/pymupdf4llm) | 使用 PyMuPDF4LLM 将 PDF 内容加载为 Markdown 格式 | Package |
| [PDFMiner](/oss/integrations/document_loaders/pdfminer) | 使用 PDFMiner 库加载 PDF 文件 | Package |
| [Upstage Document Parse Loader](/oss/integrations/document_loaders/upstage) | 使用 UpstageDocumentParseLoader 加载 PDF 文件 | Package |
| [Docling](/oss/integrations/document_loaders/docling) | 使用 Docling 库加载 PDF 文件 | Package |
| [UnDatasIO](/oss/integrations/document_loaders/undatasio) | 使用 UnDatasIO 库加载 PDF 文件 | Package |
| [OpenDataLoader PDF](/oss/integrations/document_loaders/opendataloader_pdf) | 使用 OpenDataLoader PDF 库加载 PDF 文件 | Package |
...
| [Azure Blob Storage](/oss/integrations/document_loaders/azure_blob_storage) | 从 Azure Blob 存储加载文档 | ✅ | [`AzureBlobStorageLoader`](https://reference.langchain.com/python/integrations/langchain_azure/storage/) |
...
| [Google Drive](/oss/integrations/document_loaders/google_drive) | 从 Google Drive 加载文档（仅限 Google Docs） | ✅ | [`GoogleDriveLoader`](https://python.langchain.com/api_reference/google_community/drive/langchain_google_community.drive.GoogleDriveLoader.html) |
...
| [`DoclingLoader`](/oss/integrations/document_loaders/docling) | 各种文件类型（参见 https://ds4sd.github.io/docling/） |
| [`PolarisAIDataInsightLoader`](/oss/integrations/document_loaders/polaris_ai_datainsight) | 各种文件类型（参见 https://datainsight.polarisoffice.com/documentation?docType=doc_extract） |
...
<Card title="AssemblyAI 音频转录" icon="link" href="/oss/integrations/document_loaders/assemblyai" arrow="true" cta="查看指南" />
...
<Card title="AWS S3 目录" icon="link" href="/oss/integrations/document_loaders/aws_s3_directory" arrow="true" cta="查看指南" />
<Card title="AWS S3 文件" icon="link" href="/oss/integrations/document_loaders/aws_s3_file" arrow="true" cta="查看指南" />
...
<Card title="Azure AI 文档智能" icon="link" href="/oss/integrations/document_loaders/azure_document_intelligence" arrow="true" cta="查看指南" />
...
<Card title="ChatGPT 数据" icon="link" href="/oss/integrations/document_loaders/chatgpt_loader" arrow="true" cta="查看指南" />
...
<Card title="Cube 语义层" icon="link" href="/oss/integrations/document_loaders/cube_semantic" arrow="true" cta="查看指南" />
<Card title="Datadog 日志" icon="link" href="/oss/integrations/document_loaders/datadog_logs" arrow="true" cta="查看指南" />
...
<Card title="Google Cloud Storage 目录" icon="link" href="/oss/integrations/document_loaders/google_cloud_storage_directory" arrow="true" cta="查看指南" />
<Card title="Google Cloud Storage 文件" icon="link" href="/oss/integrations/document_loaders/google_cloud_storage_file" arrow="true" cta="查看指南" />
<Card title="Google Firestore (Datastore 模式)" icon="link" href="/oss/integrations/document_loaders/google_datastore" arrow="true" cta="查看指南" />
...
<Card title="Google Firestore (原生模式)" icon="link" href="/oss/integrations/document_loaders/google_firestore" arrow="true" cta="查看指南" />
...
<Card title="Huawei OBS 目录" icon="link" href="/oss/integrations/document_loaders/huawei_obs_directory" arrow="true" cta="查看指南" />
<Card title="Huawei OBS 文件" icon="link" href="/oss/integrations/document_loaders/huawei_obs_file" arrow="true" cta="查看指南" />
<Card title="HuggingFace 数据集" icon="link" href="/oss/integrations/document_loaders/hugging_face_dataset" arrow="true" cta="查看指南" />
...
<Card title="图像" icon="link" href="/oss/integrations/document_loaders/image" arrow="true" cta="查看指南" />
<Card title="图像描述" icon="link" href="/oss/integrations/document_loaders/image_captions" arrow="true" cta="查看指南" />
...
<Card title="LarkSuite (飞书)" icon="link" href="/oss/integrations/document_loaders/larksuite" arrow="true" cta="查看指南" />
...
<Card title="PyPDFLoader" icon="link" href="/oss/integrations/document_loaders/pypdfloader" arrow="true" cta="查看指南" />
...
<Card title="ReadTheDocs 文档" icon="link" href="/oss/integrations/document_loaders/readthedocs_documentation" arrow="true" cta="查看指南" />
...
<Card title="RSS 订阅源" icon="link" href="/oss/integrations/document_loaders/rss" arrow="true" cta="查看指南" />
...
<Card title="源代码" icon="link" href="/oss/integrations/document_loaders/source_code" arrow="true" cta="查看指南" />
...
<Card title="Tencent COS 目录" icon="link" href="/oss/integrations/document_loaders/tencent_cos_directory" arrow="true" cta="查看指南" />
<Card title="Tencent COS 文件" icon="link" href="/oss/integrations/document_loaders/tencent_cos_file" arrow="true" cta="查看指南" />
...
<Card title="YouTube 音频" icon="link" href="/oss/integrations/document_loaders/youtube_audio" arrow="true" cta="查看指南" />
<Card title="YouTube 字幕" icon="link" href="/oss/integrations/document_loaders/youtube_transcript" arrow="true" cta="查看指南" />
