...
本指南将帮助您开始使用 Mistral 的[聊天模型](/oss/langchain/models)。有关所有 `ChatMistralAI` 功能和配置的详细文档，请查阅[API 参考](https://python.langchain.com/api_reference/mistralai/chat_models/langchain_mistralai.chat_models.ChatMistralAI.html)。`ChatMistralAI` 类是基于[Mistral API](https://docs.mistral.ai/api/)构建的。要查看 Mistral 支持的所有模型列表，请访问[此页面](https://docs.mistral.ai/getting-started/models/)。
