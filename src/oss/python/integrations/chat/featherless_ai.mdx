...
这将帮助您开始使用 FeatherlessAi [聊天模型](/oss/langchain/models)。有关所有 ChatFeatherlessAi 功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/__package_name_short_snake__/chat_models/__module_name__.chat_models.ChatFeatherlessAi.html)。
