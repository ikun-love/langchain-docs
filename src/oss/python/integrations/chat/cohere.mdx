...
本 Notebook 介绍如何开始使用 [Cohere 聊天模型](https://cohere.com/chat)。

请转到 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.cohere.ChatCohere.html) 以获取所有属性和方法的详细文档。
...
设置 [LangSmith](https://smith.langchain.com/)（用于实现一流的可观测性）也是有帮助的（但并非必需）：
...
`ChatCohere` 支持所有 [ChatModel](/oss/langchain/models) 功能：
