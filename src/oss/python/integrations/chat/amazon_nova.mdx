...
description: 在 LangChain 中开始使用 Amazon Nova [聊天模型](/oss/langchain/models)。
---
...
<Tip>
    **API 参考**
    ...
    有关 @[`ChatAmazonNova`] 的所有特性和配置选项的详细文档，请前往 @[`ChatAmazonNova`] API 参考。
...
| 类 (Class) | 包 (Package) | <Tooltip tip="可以在本地硬件上运行" cta="了解更多" href="/oss/langchain/models#local-models">本地</Tooltip> | 可序列化 (Serializable) | JS/TS 支持 | 下载量 (Downloads) | 最新版本 (Latest Version) |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
...
Amazon Nova 提供具有不同能力的不同模型。它支持 LangChain 的 [模型档案](/oss/langchain/models#model-profiles)。
...
有关 @[`ChatAmazonNova`] 的所有特性和配置的详细文档，请前往 @[`ChatAmazonNova`] API 参考。
