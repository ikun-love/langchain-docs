...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output#structured-output) | JSON 模式 (JSON mode) | 图像输入 (Image input) | 音频输入 (Audio input) | 视频输入 (Video input) | [Token 级流式传输](/oss/integrations/chat/litellm#async-and-streaming-functionality) | [原生异步](/oss/integrations/chat/litellm#async-and-streaming-functionalityy) | [Token 使用量](/oss/langchain/models#token-usage) | [Logprobs](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ | ❌ |
