...
这将帮助您快速上手 Yi [聊天模型](/oss/langchain/models)。有关所有 ChatYi 功能和配置的详细文档，请参阅 [API 参考文档](https://python.langchain.com/api_reference/lanchain_community/chat_models/lanchain_community.chat_models.yi.ChatYi.html)。
