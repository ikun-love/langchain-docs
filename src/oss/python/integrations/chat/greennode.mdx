...
本页面将帮助您开始使用 GreenNode Serverless AI [聊天模型](/oss/langchain/models)。有关 ChatGreenNode 所有功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/greennode/chat_models/langchain_greennode.chat_models.ChatGreenNode.html)。
...
| [工具调用](/oss/langchain/tools) (Tool calling) | [结构化输出](/oss/langchain/structured-output) (Structured output) | JSON 模式 (JSON mode) | [图像输入](/oss/langchain/messages#multimodal) (Image input) | 音频输入 (Audio input) | 视频输入 (Video input) | [Token 级流式传输](/oss/langchain/streaming#llm-tokens) (Token-level streaming) | 原生异步 (Native async) | [Token 使用量](/oss/langchain/models#token-usage) (Token usage) | [对数概率](/oss/langchain/models#log-probabilities) (Logprobs) |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | ❌ |
