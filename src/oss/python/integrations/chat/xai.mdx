---
title: ChatXAI
description: 在 LangChain 中开始使用 xAI 的 [chat 模型](/oss/langchain/models)。
---

<Warning>
    此页面引用了 [xAI](https://docs.x.ai/docs/overview) 提供的 Grok 模型——请勿与 Groq (一家独立的人工智能硬件和软件公司) 混淆。请参阅 [Groq 提供商页面](/oss/integrations/providers/groq)。
</Warning>
...
<Tip>
    **API 参考**
    ...
    如需了解所有功能和配置选项的详细文档，请访问 @[`ChatXAI`] API 参考。
</Tip>
...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output) | JSON 模式 | [图像输入](/oss/langchain/messages#multimodal) | 音频输入 | 视频输入 | [Token 级别流式传输](/oss/langchain/streaming#llm-tokens) | 原生异步 | [Token 使用情况](/oss/langchain/models#token-usage) | [对数概率](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ✅ | ✅ |
