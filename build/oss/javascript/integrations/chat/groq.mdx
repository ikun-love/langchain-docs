...
[Groq](https://groq.com/) 是一家提供快速 AI 推理服务的公司，其技术基于 LPU™ AI 推理技术，能够实现快速、经济和高能效的 AI 运算。

本指南将帮助您快速上手 ChatGroq [聊天模型](/oss/javascript/langchain/models)。如需了解 ChatGroq 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_groq.ChatGroq.html)。
...
请参阅下方表格标题中的链接，以获取关于如何使用特定功能的指南。
...
如果您希望对模型调用进行自动跟踪，也可以取消注释以下内容来设置您的 [LangSmith](https://docs.smith.langchain.com/) API 密钥：
...
如需了解 ChatGroq 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_groq.ChatGroq.html)。
