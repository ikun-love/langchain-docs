...
本文将引导您开始使用 [LocalFileStore](/oss/javascript/integrations/stores)。如需了解所有 `LocalFileStore` 功能和配置的详细文档，请查阅 [API 参考](https://api.js.langchain.com/classes/langchain.storage_file_system.LocalFileStore.html)。
