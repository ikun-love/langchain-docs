...
本文将指导您入门 Tavily 搜索 API [检索器（retriever）](/oss/javascript/langchain/retrieval) 的使用。如需了解 `TavilySearchAPIRetriever` 所有功能和配置的详细文档，请参阅[API 参考](https://api.js.langchain.com/classes/langchain_community_retrievers_tavily_search_api.TavilySearchAPIRetriever.html)。
