...
本指南将帮助您入门 [AzionRetriever](/oss/javascript/langchain/retrieval)。要了解 AzionRetriever 所有功能和配置的详细文档，请访问 [API 参考](https://api.js.langchain.com/classes/_langchain_community.retrievers_azion_edgesql.AzionRetriever.html)。
