...
本 Notebook 提供了关于如何开始使用 [DuckDuckGoSearch](/oss/javascript/integrations/tools/) 的快速概览。如需了解 DuckDuckGoSearch 所有功能和配置的详细文档，请前往 [API 参考](https://api.js.langchain.com/classes/langchain_community_tools_duckduckgo_search.DuckDuckGoSearch.html)。
...
我们可以通过首先将工具绑定到一个 [工具调用模型](/oss/javascript/langchain/tools/)，然后调用它来实现工具的使用：
