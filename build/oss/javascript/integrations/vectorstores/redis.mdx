...
本指南将快速概述 Redis [向量存储](/oss/javascript/integrations/vectorstores) 的入门方法。有关 `RedisVectorStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_redis.RedisVectorStore.html)。
...
您还可以将向量存储转换为[检索器](/oss/javascript/langchain/retrieval)，以便在链中使用更方便：
