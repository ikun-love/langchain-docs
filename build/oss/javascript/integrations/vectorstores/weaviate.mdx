...
本指南快速概述了如何开始使用 Weaviate [向量存储](/oss/javascript/integrations/vectorstores)。有关 `WeaviateStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_weaviate.WeaviateStore.html)。
...
本指南还将使用 [OpenAI 嵌入模型](/oss/javascript/integrations/text_embedding/openai)，这要求您安装 `@langchain/openai` 集成包。如果您愿意，也可以使用 [其他支持的嵌入模型](/oss/javascript/integrations/text_embedding)。
