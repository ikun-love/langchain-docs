...
本指南快速概述了如何开始使用 mariadb [向量存储](/oss/javascript/integrations/vectorstores)。有关所有 `MariaDB store` 功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_vectorstores_mariadb.MariaDBStore.html)。
