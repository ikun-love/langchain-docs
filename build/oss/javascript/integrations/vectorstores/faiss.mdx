...
本指南快速概述了如何开始使用 Faiss [向量存储](/oss/javascript/integrations/vectorstores)。要获取所有 `FaissStore` 功能和配置的详细文档，请访问 [API 参考](https://api.js.langchain.com/classes/langchain_community_vectorstores_faiss.FaissStore.html)。
...
您也可以将向量存储转换为 [检索器 (retriever)](/oss/javascript/langchain/retrieval)，以便在链中使用更方便。
