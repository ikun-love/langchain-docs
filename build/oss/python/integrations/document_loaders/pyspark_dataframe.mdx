...
本 Notebook 介绍如何从 [PySpark](https://spark.apache.org/docs/latest/api/python/) DataFrame 中加载数据。
...
23/05/31 14:08:33 WARN NativeCodeLoader: 无法为您的平台加载 native-hadoop 库... 在适用的情况下使用内置的 Java 类。
```
