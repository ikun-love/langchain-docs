---
title: HuggingFace 数据集
---

> [Hugging Face Hub](https://huggingface.co/docs/hub/index) 托管了超过 5,000 个[数据集](https://huggingface.co/docs/hub/index#datasets)，涵盖 100 多种语言，可用于自然语言处理（NLP）、计算机视觉和音频等广泛任务。它们常被用于翻译、自动语音识别和图像分类等多样化任务。

本示例 Notebook 展示了如何将 `Hugging Face Hub` 数据集加载到 LangChain 中。
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\document_loaders\hugging_face_dataset.mdx)
</Callout>
