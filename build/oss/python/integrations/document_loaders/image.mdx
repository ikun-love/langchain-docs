...
这部分内容介绍了如何将图像加载到文档格式中，以便后续在其他 LangChain 模块中使用。

它使用 [Unstructured](https://unstructured.io/) 来处理各种图像格式，例如 `.jpg` 和 `.png`。有关在本地设置 Unstructured 的更多说明，包括设置所需的系统依赖项，请参阅[本指南](/oss/python/integrations/providers/unstructured/)。
