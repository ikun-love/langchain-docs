...
> **[NetworkX](https://networkx.org/)** 是一个 Python 包，用于创建、操作和研究复杂网络的结构、动态和功能。

本示例 Notebook 将介绍如何对图数据结构执行问答操作。
...
在本节中，我们将构建一个示例图。目前，此方法最适用于小段文本。
...
我们只使用一小段文本片段，因为目前知识三元组（Knowledge Triplets）的提取过程计算量较大。
...
我们现在可以使用图问答链（Graph QA Chain）来针对该图提出问题。
