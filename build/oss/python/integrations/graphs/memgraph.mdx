...
除了[设置部分](#setting-up)中的所有导入之外，还需要导入 `LLMGraphTransformer` 和 [`Document`](https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document) 来用于从文本中提取结构化信息。
