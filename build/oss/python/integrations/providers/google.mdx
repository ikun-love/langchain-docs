...
<Columns cols={2}>
    ...
    <Card title="Anthropic on Vertex AI Model Garden" icon="comments" href="/oss/python/integrations/llms/google_vertex_ai" cta="开始使用" arrow />
</Columns>
...
<Columns cols={2}>
    ...
    <Card title="With DataStore Backend" href="/oss/python/integrations/vectorstores/google_vertex_ai_vector_search/#optional--you-can-also-create-vectore-and-store-chunks-in-a-datastore" cta="开始使用" arrow>
...
<Columns cols={2}>
    <Card title="Gmail" icon="envelope" href="/oss/python/integrations/tools/google_gmail" cta="开始使用" arrow>
...
<Columns cols={2}>
    <Card title="Gmail" icon="envelope" href="/oss/python/integrations/chat_loaders/google_gmail" cta="开始使用" arrow>
