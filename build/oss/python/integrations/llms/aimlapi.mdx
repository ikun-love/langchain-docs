...
<Warning>
**您当前正在浏览的是记录如何将 AI/ML API 模型用作文本补全（text completion）模型的页面。许多最新且最流行的 AI/ML API 模型实际上是 [聊天补全模型](/oss/python/langchain/models)。**

您可能需要查看 [这个页面](/oss/python/integrations/chat/aimlapi)。
</Warning>
...
| [工具调用](/oss/python/langchain/tools) | [结构化输出](/oss/python/langchain/structured-output) | JSON 模式 (JSON mode) | [图像输入](/oss/python/langchain/messages#multimodal) | 音频输入 (Audio input) | 视频输入 (Video input) | [逐词流式传输](/oss/python/langchain/streaming/) | 原生异步 (Native async) | [Token 使用量](/oss/python/langchain/models#token-usage) | [Logprobs](/oss/python/langchain/models#log-probabilities) |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
