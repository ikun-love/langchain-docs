...
本 Notebook 将介绍如何使用 Google Trends 工具来获取趋势信息。
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\google_trends.mdx)
</Callout>
