...
> [维基百科](https://wikipedia.org/)是一个多语种的免费在线百科全书，由一群被称为“维基人”的志愿者通过开放协作和使用名为 MediaWiki 的基于 wiki 的编辑系统来撰写和维护。`Wikipedia` 是历史上规模最大、阅读人数最多的参考资料。
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\wikipedia.mdx)
</Callout>
