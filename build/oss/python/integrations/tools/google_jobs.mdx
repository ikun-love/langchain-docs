...
并使用 `[`create_agent`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent)` 功能来初始化一个 ReAct Agent。您还需要设置您的 `OPEN_API_KEY`（请访问 [platform.openai.com](https://platform.openai.com)）才能访问 OpenAI 的聊天模型。
