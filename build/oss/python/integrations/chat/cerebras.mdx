...
本指南提供了关于开始使用 Cerebras [聊天模型](/oss/python/langchain/models) 的快速概览。有关 ChatCerebras 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/cerebras/chat_models/langchain_cerebras.chat_models.ChatCerebras.html#)。
