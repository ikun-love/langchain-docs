...
Coze.com 提供的 ChatCoze 聊天模型 API。更多信息请参阅 [https://www.coze.com/open/docs/chat](https://www.coze.com/open/docs/chat)
...
或者，您可以通过设置环境变量来配置 API 密钥和 API 基础地址：
