...
这将帮助您开始使用 FeatherlessAi [聊天模型](/oss/python/langchain/models)。有关所有 ChatFeatherlessAi 功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/__package_name_short_snake__/chat_models/__module_name__.chat_models.ChatFeatherlessAi.html)。
...
访问 [featherless.ai/](https://featherless.ai/) 注册 FeatherlessAI 并生成 API 密钥。完成此操作后，请设置 `FEATHERLESSAI_API_KEY` 环境变量：
...
如果您想自动跟踪您的模型调用，可以取消注释下方代码行，设置您的 [LangSmith](https://docs.smith.langchain.com/) API 密钥：
...
```output
c:\Python311\Lib\site-site-packages\pydantic\main.py:463: UserWarning: Pydantic serializer warnings:
...
有关所有 ChatFeatherlessAi 功能和配置的详细文档，请访问 [API 参考](https://python.langchain.com/api_reference/__package_name_short_snake__/chat_models/.chat_models.ChatFeatherlessAi.html)
