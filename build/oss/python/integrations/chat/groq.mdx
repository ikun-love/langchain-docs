...
title: ChatGroq
sidebarTitle: Groq
description: 在 LangChain 中开始使用 Groq 的 [聊天模型](/oss/python/langchain/models)。
---

<Warning>
    此页面引用了 [Groq](https://console.groq.com/docs/overview)，这是一家 AI 硬件和软件公司。要了解如何使用 Grok 模型（由 [xAI](https://docs.x.ai/docs/overview) 提供），请参阅 [xAI 提供商页面](/oss/python/integrations/providers/xai)。
</Warning>

<Tip>
    **API 参考**

    有关所有功能和配置选项的详细文档，请前往 [`ChatGroq`](https://reference.langchain.com/python/integrations/langchain_groq/#langchain_groq.ChatGroq) API 参考。
</Tip>
